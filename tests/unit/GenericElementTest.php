...
class GenericElementTest extends TestCase
{
    ...
    {
        $expected = 'a';
        $el = new GenericElement('a',$expected, ElementBehavior::DATA_COPY_ASSIGNMENT);
    ...
    {
        $el = new GenericElement('a','a', ElementBehavior::DATA_COPY_ASSIGNMENT);
        $clonedEl = $el->clone();
    ...
    public function testGetDataWithDataCloneWillCloneDataOnConstruct(): void
    {
        ...
        $el = new GenericElement($a,'a', ElementBehavior::DATA_CLONE_WHERE_POSSIBLE);
        $a->val = '2';
        $elA = $el->getData();
    ...
    {
        $a = new \stdClass();
        $el = new GenericElement($a,'a', ElementBehavior::DATA_COPY_WITH_WEAKREF);
        unset($a);
        $elData = $el->getData();
